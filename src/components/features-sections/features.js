...
function FeaturesSection1() {
  ...
  <center>
    ...
    <h2 className='h22'>Analytics that feels like its from the future</h2>
      <p style={{fontSize:'20px',color: '#475467'
}}>Powerful, self-serve product and growth analytics to help you convert, engage<br></br> and retain more users. Trusted by over 4,000 startups.</p>
<div className="row g-4 py-5 row-cols-1 row-cols-lg-3" style={{marginLeft:'10%'}}>
